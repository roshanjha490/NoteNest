...
import { create_new_file } from '@/app/actions';

const CreateFile = ({ FileItem, index, onClose, onUpdate }) => {

    const closeModal = () => {
        onClose();
    }

    let CreateFileFormSchema = z.object({
    ...
    async function onSubmit(formData) {
        ...
        const result = await create_new_file(formData)
