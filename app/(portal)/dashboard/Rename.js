...
import { rename_item } from '@/app/actions';

const Rename = ({ FileItem, index, onClose, onUpdate }) => {
    ...
    async function onSubmit(formData) {
        ...
        const result = await rename_item(formData)
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="p-4 md:p-5">
                        ...
                        <div className="grid gap-4 mb-[30px] grid-cols-1">
                            <div className="col-span-2 sm:col-span-1">
                                ...
                                <input defaultValue={FileItem.name} type="text" {...register("name")} id="name" className="m-[0px] bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" />
                                {errors.name && (
                                    <>
